      ...
      <div className="col-md-10 col-md-offset-1">
        ...
        <div className="col-md-12">
          <div className="row">
            ...
            {this.props.loader ? this.props.loader : renderFeed}
          </div>
        </div>
      </div>
    )
...
class App extends Component {
  ...
  let url = "https://newsapi.org/v1/articles?source=hacker-news&sortBy=latest&apiKey=92f2c9930d5044cfad746508a4ab0637";
...
render() {
  return (
    <div className="App row">
      ...
      <Feed feed={this.state.feed} loader={this.state.loader} onClick={this.handleClick} />
